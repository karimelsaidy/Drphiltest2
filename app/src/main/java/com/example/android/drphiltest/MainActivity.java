...
// initialize the variables
        TextView message = (TextView) findViewById(R.id.hint);
    ...
    public void displayPoints() {
        ...
        TextView message = (TextView) findViewById(R.id.hint);
        RadioGroup radioGroup1 = (RadioGroup) findViewById(R.id.ans1);
        RadioGroup radioGroup2 = (RadioGroup) findViewById(R.id.ans2);
        RadioGroup radioGroup3 = (RadioGroup) findViewById(R.id.ans3);
        RadioGroup radioGroup4 = (RadioGroup) findViewById(R.id.ans4);
        RadioGroup radioGroup5 = (RadioGroup) findViewById(R.id.ans5);
        RadioGroup radioGroup6 = (RadioGroup) findViewById(R.id.ans6);
        RadioGroup radioGroup7 = (RadioGroup) findViewById(R.id.ans7);
        RadioGroup radioGroup8 = (RadioGroup) findViewById(R.id.ans8);
        RadioGroup radioGroup9 = (RadioGroup) findViewById(R.id.ans9);
        RadioGroup radioGroup10 = (RadioGroup) findViewById(R.id.ans10);
        ...
        if (radioGroup1.getCheckedRadioButtonId() == -1 || radioGroup2.getCheckedRadioButtonId() == -1 ||
            ...
            if (points >= 60) {
                message.setText(getString(R.string.points) + points + "\n " + getString(R.string.greater60));
                message.setTextAppearance(this, R.style.result);
                ...
                message.setText(getString(R.string.greater30));
                message.setTextAppearance(this, R.style.result);
    ...
    public void reset(View v) {
        ...
        message.setTextAppearance(this, R.style.hint);
        message.setText(getString(R.string.hint));
    }
}
